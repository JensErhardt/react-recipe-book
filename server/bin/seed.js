...
const Ingredient = require('../models/istarseedsngridients');

const dbName = 'react-recipe-book';
...
Ingredient.deleteMany()
  .then(() => {
    ...
    console.log("created services", ingredients.length)
  })
  .then(() => {
     Dish.create(dishes)
     console.log("created users", dishes.length)
  })
  .then(() => {
